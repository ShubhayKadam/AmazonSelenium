...
public class Steps {
	...
	public void window_with_title_amazon_com_spend_less_smile_more_should_be_opened() {
	   String title = driver.getTitle();
	   Assert.assertEquals(title, "Amazon.com. Spend less. Smile more.");
	}
	@When("User Sets the location zip to 10001")
	public void user_set_the_location_to_NewYork(String zipCode) throws InterruptedException {
	    mtr.setLocation(zipCode);
	}
	
	@Then("Location should be updated to New York")
	public void location_should_be_updated_to_NewYork(String location) throws InterruptedException {
	...
	public void first_monitor_s_information_page_should_be_displayed() {
	...
	@Then("User should be able to get price of the product")
	...
	public void product_should_get_added_in_the_cart() {
